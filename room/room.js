...
function renderLogin(){
  app.className="room-gate"; app.innerHTML=`<a class="back-link" href="../">← back to our little world</a><section class="gate-card"><div class="lock-orbit">♡</div><p class="eyebrow">hey! ive missed you lots.</p><h1>Welcome back!</h1><p class="gate-copy">Choose the account.</p><div class="identity-grid"><button data-id="ash"><span>🤍</span>Ash</button><button data-id="rex"><span>❤️</span>Rex</button></div><p id="errorBox" class="error-note hidden"></p><p class="privacy-note">i want you back</p></section>`;
